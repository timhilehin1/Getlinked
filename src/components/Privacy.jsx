...
function Privacy() {
	return (
		<section className='py-16 grid grid-cols-1  md:grid md:grid-cols-2  gap-4 mx-auto container items-center'>
			...
			<div className='w-full py-4 px-2 text-center border border-[#D434FE] leading-7 flex flex-col gap-4'>
				<p>
			...
			<div className='images relative w-full'>
				<img className='absolute left-10 right-0' src={privacy1} alt='privacy1' />
                <img className='mt-16' src={privacy2} alt='privacy2' />
			</div>
		</section>
	);
}
